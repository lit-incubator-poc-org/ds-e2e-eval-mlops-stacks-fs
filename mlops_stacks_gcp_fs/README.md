...
- [🔧 Model Details](#-model-details)
  - [Algorithm: LightGBM Gradient Boosting](#algorithm-lightgbm-gradient-boosting)
  - [Input Features](#input-features)
- [📊 Raw Data Overview](#-raw-data-overview)
  - [NYC Taxi Raw Dataset](#nyc-taxi-raw-dataset-databricks-datasetsnyctaxi-with-zipcodessubsampled)
- [🏪 Feature Store Architecture](#-feature-store-architecture)
  ...
  - [Feature Tables](#feature-tables)
    - [1. Pickup Features](#1-pickup-features-p03e2e_demo_simontrip_pickup_features-see-sample-datapickup-features-table-sample)
    - [2. Dropoff Features](#2-dropoff-features-p03e2e_demo_simontrip_dropoff_features-see-sample-datadropoff-features-table-sample)
  - [📊 Sample Feature Table Data](#-sample-feature-table-data)
    - [Pickup Features Table Sample](#pickup-features-table-sample)
    - [Dropoff Features Table Sample](#dropoff-features-table-sample)
    - [Feature Table Schema](#feature-table-schema)
- [⚙️ Feature Engineering Pipeline](#️-feature-engineering-pipeline)
  - [1. Timestamp Rounding](#1-timestamp-rounding)
  - [2. Aggregation Features](#2-aggregation-features)
  - [3. UDF-Free Implementation](#3-udf-free-implementation)
- [🚀 Training Pipeline](#-training-pipeline)
  - [Process Flow](#process-flow)
  - [Feature Lookup Configuration](#feature-lookup-configuration)
- [📊 Deployment & Inference](#-deployment--inference)
  - [1. Model Deployment](#1-model-deployment)
  - [2. Why Features Are Critical During Inference](#2-why-features-are-critical-during-inference)
    - [🕐 Temporal Context Features](#-temporal-context-features)
    - [🌍 Geographic Context Features](#-geographic-context-features)
    - [⚡ Real-Time Feature Requirements](#-real-time-feature-requirements)
    - [🎯 Business Impact Without Features](#-business-impact-without-features)
  - [3. Batch Inference](#3-batch-inference)
    - [📦 Overview](#-overview-1)
    - [🔧 Implementation](#-implementation)
    - [📊 Sample Batch Output](#-sample-batch-output)
  - [4. Real-time API Inference](#4-real-time-api-inference)
    - [🔄 Feature Store Integration During Inference](#-feature-store-integration-during-inference)
    - [📥 API Input Schema](#-api-input-schema-what-you-send)
    - [🧮 Model Signature Schema](#-model-signature-schema-what-the-model-receives-after-feature-store)
...
- [🔄 What Happens During Inference](#-what-happens-during-inference)
  - [Step-by-Step Inference Flow](#step-by-step-inference-flow)
    - [Step 1: API Request Received](#step-1-api-request-received)
    - [Step 2: Input Validation & Preprocessing](#step-2-input-validation--preprocessing)
    - [Step 3: Feature Store Lookups](#step-3-feature-store-lookups)
    - [Step 4: Feature Vector Assembly](#step-4-feature-vector-assembly)
    - [Step 5: Model Prediction](#step-5-model-prediction)
    - [Step 6: Response Assembly](#step-6-response-assembly)
  - [🕐 Real-Time Feature Computation Example](#-real-time-feature-computation-example)
    - [Pickup Features (zip: 10001)](#pickup-features-zip-10001)
    - [Dropoff Features (zip: 10019)](#dropoff-features-zip-10019)
